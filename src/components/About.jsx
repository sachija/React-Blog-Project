...
import { Link } from 'react-router-dom';
 ...
 const About =()=> {
  ...
  return (
    ...
    {
                bottom.map((item7)=>{return( <PageDown header={item7.header} description={item7.description} tag1={item7.tag1} tag2={item7.tag2} imgurl={item7.background} imgex={item7.imgex}/> )})
            }
    </div>
