...
export const mainBolly = [
    {
      bollyhead:"Katrina kaif",
      bollydesc:"A role model for generations to come,Katrina kaif  is hailed as the greatest  "  ,
      bollytags:['Mint','/ December 21 2020'],
      bollyimg:require("../pics/kat.jpg")

    },
    {
        bollyhead:"a perfect COUPLE",
        bollydesc:" Katrina Kaif, who tied the knot with Vicky Kaushal in December 2021, opens...   "  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/katvicky.jpg")
  
    },
    {
        bollyhead:"Big B",
        bollydesc:" Amitabh Bachchan, who made his Bollywood debut in 1969 with "  ,
        bollytags:['Mint','/December 01 2021'],
        bollyimg:require("../pics/bigb.jpg")
  
    },
    {
        bollyhead:"Sushant Sigh Rajput",
        bollydesc:"2006–2011: Early career and television During his course ' " ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/ssr.jpg")
  
    },
    {
        bollyhead:"Rajkumar Rao",
        bollydesc:"When you think of comedy and Bollywood, this superstar's name "  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/rajkumar.jpg")
  
    },
    {
        bollyhead:"Bhramhastra ",
        bollydesc:"Indian Hindi-language fantasy action-adventure film written ."  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/bhr.jpg")
  
    },
    {
        bollyhead:"Ramsetu",
        bollydesc:"Ram Setu (transl. Rama's bridge) is an upcoming Akshay Kumar"  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/ramsetu.jpg")
...
export const mainSecond=[
    {
        secnum:"2",
        sectitle:"'upcoming movie of Akshay'",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/ramsetu.jpg")
    },
    {
        secnum:"3",
        sectitle:"'bhramhastra succesful or not'",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/bhr.jpg")
    },
    {
        secnum:"4",
        sectitle:"'fav actor of industry'",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/sid.jpg")
    }
]
...
export const mainThird=[
    {
        ...
        sectitle:"Automation",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/robo.jpg")
    },
    {
        secnum:"3",
        sectitle:"Instrumentation and Control",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/auto.jpg")
    },
    {
        secnum:"4",
        sectitle:"Control Engineering",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/auto.jpg")
    }
]
...
export const mainHolly = [
    {
      bollyhead:"Angelina geli",
      bollydesc:"Angelina Jolie DCMG is an American actress, filmmaker, and humanitarian. "  ,
      bollytags:['Mint','/ December 21 2020'],
      bollyimg:require("../pics/ag.jpg")

    },
    {
        bollyhead:"Shawn Mendes",
        bollydesc:"A multi-talented person because in the Hollywood industry people "  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/sm.jpg")
  
    },
    {
        bollyhead:"Pop start JB",
        bollydesc:"Teen pop star turned versatile, Grammy-winning hitmaker who has"  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/jb.jpg")

  
    },
    {
        bollyhead:"Charlie puth",
        bollydesc:"American singer who has done many exceptional movies like Titanic,"  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/cp.jpg")
  
    },
    {
        bollyhead:"Tom Cruise",
        bollydesc:"In 1976, if you had told fourteen-year-old Franciscan seminary   "  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/tc.jpg")
  
    },
    {
        bollyhead:"shawn mendes",
        bollydesc:"In 1976, if you had told fourteen-year-old Franciscan  ",
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/sm.jpg")
  
    },
    {
        bollyhead:" justin biber",
        bollydesc:"Teen pop star turned versatile, Grammy-winning hitmaker who has ." ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/jb.jpg")
...
export const mainFourth=[
    {
        secnum:"2",
        sectitle:"Teen Pop Star",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/cp.jpg")
    },
    {
        secnum:"3",
        sectitle:"Famous Singer",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/sm.jpg")
    },
    {
        secnum:"4",
        sectitle:"Famous singer",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/jb.jpg")
    }
]

export const mainFitness = [
    {
      bollyhead:"Stay Healthy",
      bollydesc:"Dr Ambrish Mithal, Chairman and Head of Diabetes and Endocrinology  "  ,
      bollytags:['Mint','/ December 21 2020'],
      bollyimg:require("../pics/fitt2.jpg")

    },
    {
        bollyhead:"Do Yoga",
        bollydesc:"This Beginner's Yoga Session Will Make You Feel Pure Joy"  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/fitt3.jpg")
  
    },
    {
        bollyhead:"Stay fit",
        bollydesc:"  Exercise can help prevent excess weight gain or help maintain …"  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/fitt1.jpg")

  
    },
    {
        bollyhead:"stay fit",
        bollydesc:"Exercise combats health conditions and diseases. Worried about heart disease? "  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/fitt4.jpg")
  
    },
    {
        bollyhead:"Benefits OF exercise",
        bollydesc:"Exercise improves mood. Need an emotional lift? Or need to"  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/fitt5.jpg")
    ...
    },
    {
        ...
        bollydesc:"Exercise combats health conditions and diseases. Worried about heart disease? "  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/fitt6.jpg")
  
    },
    {
        bollyhead:"worried about health?",
        bollydesc:"Exercise combats health conditions and diseases. Worried about heart disease?"  ,
        bollytags:['Mint','/ December 21 2020'],
        bollyimg:require("../pics/fitt4.jpg")
...
export const mainFifth=[
    {
        secnum:"2",
        sectitle:"worried about health",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/fitt1.jpg")
    },
    {
        secnum:"3",
        sectitle:" DO Yoga",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/fitt2.jpg")
    },
    {
        secnum:"4",
        sectitle:"DO exercise regularly",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/fitt3.jpg")
    }
]
...
export const mainSixth=[
    {
        secnum:"2",
        sectitle:"Healthy Foods",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/rice.jpg")
    },
    {
        secnum:"3",
        sectitle:"Healthy Foods",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/veg.jpg")
    },
    {
        secnum:"4",
        sectitle:"Healthy Foods",
        sectags:['','/ December 21 2020'],
        secimg:require("../pics/lemon.jpg")
    }
]
...
export const bottom = [
    ...
    },
    {
        ...
        tag1:'Dmitry Nozhenko',
        tag2:'Jan 28,2019 10 min read',
        background:require("../pics/build.jpg"),
        imgex:require("../pics/pune.jpg")
    },
    {   
        header:"Related Reads",
        description:"Pune",
