...
import { mainHolly,mainFourth} from "./ImpData";
                ...
                
             {
                 mainHolly.map((item4,index4)=>{
                    return(
                        ...
                        <PageFirst bollyhead={item4.bollyhead } bollydesc={item4.bollydesc} bollytags={item4.bollytags} bollyimg={item4.bollyimg}/>
                        </>
                    )
                 })
             } 
                ...
                <div className="toppost">
                 ...
                 mainFourth.map((item5,index5)=>{
                    return(
                        ...
                        <PageSecond secnum={item5.secnum } sectitle={item5.sectitle} sectags={item5.sectags} secimg={item5.secimg}/>
                        </>
                    )
                 })
             } 
